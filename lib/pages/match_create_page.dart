          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(hintText: 'Score Équipe 1'),
              ),
              const SizedBox(height: 8),
              TextField(
                controller: _scoreTeam2Controller,
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(hintText: 'Score Équipe 2'),
              ),
              const SizedBox(height: 16),
              ElevatedButton(
                onPressed: () {
                  // Ici, tu peux ajouter la logique pour sauvegarder les données
                  Navigator.of(context).pop(); // Fermer le panneau après la sauvegarde
                },
